...
import pytest
from source_dcl.source import DclStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(DclStream, "path", "v0/example_endpoint")
    mocker.patch.object(DclStream, "primary_key", "test_primary_key")
    mocker.patch.object(DclStream, "__abstractmethods__", set())
